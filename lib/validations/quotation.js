...
const quotationItemSchema = z.object({
    ...
    // Chi tiết nội thất
    functionality: optStr,
    functionalImages: z.any().optional().default([]),
    attachments: z.any().optional().default([]),
    bodyColorCode: optStr,
    bodyColorName: optStr,
    bodyColorImage: optStr,
    doorColorCode: optStr,
    doorColorName: optStr,
    doorColorImage: optStr,
    hardware: optStr,
    renderImage: optStr,
});
