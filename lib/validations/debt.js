...
export const supplierDebtCreateSchema = z.object({
    ...
    totalAmount: z.number().finite().min(0, 'Số tiền phải >= 0').max(1_000_000_000_000, 'Số tiền quá lớn'),
    date: optDate,
    dueDate: optDate,
    proofUrl: optStr,
    notes: optStr,
...
export const debtPaymentSchema = z.object({
    amount: z.number().finite().min(1, 'Số tiền phải ≥ 1đ').max(1_000_000_000_000, 'Số tiền quá lớn'),
    date: optDate,
    notes: optStr,
    proofUrl: optStr,
